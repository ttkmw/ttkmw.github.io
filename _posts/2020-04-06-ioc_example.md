...
이 포스트에서는 지난 [토비의스프링 1장](https://ttkmw.github.io/2020/03/25/toby01) 글을 쉽게 이해하기 위해 일상 생활(가구만들기)에 IoC를 적용해봤습니다. 예제코드는 [이 리포지토리](https://github.com/ttkmw/ioc-example)에서 보실 수 있습니다. 글에도 Commit은 확실히 표시해놨으니, 글과 커밋을 매칭시키며 보면 좋을 것 같습니다.
